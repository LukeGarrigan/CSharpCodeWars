...
{
      private PyramidSlideDown _sut;
      
      [SetUp]
      public void Setup()
      {
          _sut = new PyramidSlideDown();
      }
      ...
      public void SmallPyramidTest()
      {
          ...
          Assert.AreEqual(23, _sut.LongestSlideDown(smallPyramid));
      }
      ...
      public void MediumPyramidTest()
      {
          ...
          Assert.AreEqual(1074, _sut.LongestSlideDown(mediumPyramid));
      }
}
