...
namespace CSharpCodeWars.Kyu7.StringsEndWith;

public class StringsEndWithTests
{
      private StringsEndWith _sut;
      
      [SetUp]
      public void Setup()
      {
          _sut = new StringsEndWith();
      }
      ...
      {
          Assert.AreEqual(expected, _sut.Solution(str, ending));
      }
}
